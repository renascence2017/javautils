...
public class RegexUtils {
	 ...
	 */
	public static boolean emailRegexValidate(String email) {
	 ...
	 * @return
	 */
	public static boolean doubleValidate(String value) {
	 ...
	 * @return
	 */
	public static boolean integerValidate(String value) {
